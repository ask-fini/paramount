...
export default function Navbar() {
  ...
  const routesToDisplay = ['/overview', '/evaluate', '/optimize']
  const routes = [
    { id: 1, to: routesToDisplay[0], name: 'Overview' },
    { id: 2, to: routesToDisplay[1], name: 'Evaluate' },
    { id: 3, to: routesToDisplay[2], name: 'Optimize' },
  ]
